...
{
    //const char* winTitle = ";
   // std::string myString="Software Render";

    //LPTSTR  WindowTitle =myString.c_str();
    USHORT  Width = 800;
    USHORT  Height = 600;
    HDC     hDC = NULL;
    RECT    rc;
    ...
    wc.lpszClassName = _T("Software Render");
    RegisterClass(&wc);


    // Create the rendering window
    m_hWnd = CreateWindow(_T("Software Render"), _T("Software Render"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,
        CW_USEDEFAULT, Width, Height, NULL, LoadMenu(wc.hInstance, MAKEINTRESOURCE(IDR_MENU1)),
        wc.hInstance, this);
